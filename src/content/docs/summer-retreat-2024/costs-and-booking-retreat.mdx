...
template: splash
hero:
  tagline: These costs are only for the Summer Retreat 2024. We suggest a 2 week stay and the costs are for the same.
  actions:
    - text: How to reach Curry Hostel
      link: /about/how-to-reach-curry-hostel
      icon: right-arrow
      variant: primary
---
